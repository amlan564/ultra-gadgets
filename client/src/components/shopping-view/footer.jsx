...
const ShoppingFooter = () => {
  return (
    <footer className="w-full px-6 xl:px-30 pt-12">
      <div className="grid lg:grid-cols-6 gap-6 pb-6">
        {/* install app */}
        ...
        <div className="col-span-2">
          <div>
            <Link
              to="/shop/home"
              className="flex items-center gap-2 text-[#00684a]"
            >
              <span className="text-xl font-bold">UltraGadgets</span>
            </Link>
          </div>
          <div className="mt-4 flex flex-col gap-3">
            {shopInfoData.map((item) => (
              ...
              >
                {<item.icon className={` ${item.id !== 1 ? "size-4" : "size-5"} lg:size-5 text-[#00684a]`} />}
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 lg:gap-0 py-6">
